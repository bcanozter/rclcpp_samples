...
public:
        ...
        : Node("custom_qos_subscriber")
    {
        ...
        // or .keep_all() for KEEP_ALL: https://github.com/ros2/rclcpp/blob/rolling/rclcpp/include/rclcpp/qos.hpp#L178
        ...
        subscription_ = this->create_subscription<std_msgs::msg::String>(
            "topic", qos_profile, std::bind(&CustomQosSubscriber::topic_callback, this, placeholders::_1), options);
    }
